...
mod tests {
    use super::{
        BASE_PAGE_SIZE, BootAllocation, BootAllocationError, BootAllocator, ExtentError,
        FrameAllocationError, FrameAllocator, MAX_FIRMWARE_REGIONS, Mapping, MappingLifetime,
        MappingMemoryType, MappingOwner, MappingPermissions, MappingPlan, MappingPlanError,
        MappingPrivilege, MemoryMapError, MemoryRegion, NormalizedMemoryMap, PhysicalExtents,
        PhysicalRange, RegionKind, VirtualRange,
    };
