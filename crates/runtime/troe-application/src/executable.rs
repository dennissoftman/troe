...
use crate::{
    ...
    HEADER_RESERVED16, HEADER_RESERVED64, HEADER_STACK_PAGES, HEADER_TARGET,
    KEX_V1_DECLARED_SPAN_ABI_MINOR, KEX_V1_HEADER_BYTES, KEX_V1_IMAGE_ALIGNMENT, KEX_V1_IMAGE_BASE,
    KEX_V1_LEGACY_IMAGE_SPAN_BYTES, KEX_V1_LOAD_RECORD_BYTES, KEX_V1_MAGIC, KEX_V1_MIN_IMAGE_BASE,
    KEX_V1_RELOCATION_RECORD_BYTES, KEX_V1_USER_END, LoadCharges, LoadPlan, LoadSegment,
    MAX_LOAD_RECORDS, PAGE_SIZE, RECORD_FILE_BYTES, RECORD_FILE_OFFSET, RECORD_IMAGE_OFFSET,
    RECORD_MEMORY_BYTES, RECORD_PERMISSIONS, RECORD_RESERVED, RELOCATION_TARGET_OFFSET,
    RELOCATION_VALUE_OFFSET, STARTUP_PAGES, canonical_image_span_bytes, maximum_table_pages,
};
use core::fmt;
...
pub(crate) fn parse_header_with_len(
    ...
    if read_u16(header, HEADER_FLAGS)? != 0
        ...
        || read_u64(header, HEADER_RESERVED64)? != 0
    {
        return Err(ParseError::NonzeroReserved);
    }
