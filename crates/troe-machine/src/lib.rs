...
pub use mechanism::{
    ...
    input_interrupt_stats, mark_firmware_exited, monotonic_millis, park, probe_allocation_failure,
    read_byte, run_task_step, take_interrupt_ownership, try_input_event, try_read_byte,
    try_read_keyboard_scancode, wait_for_input_event, write, zero_physical_range,
};
