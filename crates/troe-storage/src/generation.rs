...
use troe_config::{ActivationPointer, ConfigReference, FailureAction, SystemConfig, parse_config};
use troe_content::{ContentDigest, ContentPack, GenerationManifest, ObjectKind, SecurityManifest};
use troe_identity::{
...
mod tests {
    ...
    use troe_config::{ActivationPointer, ActivationRecovery, ConfigReference, recover_activation};
    use troe_content::{ContentDigest, ContentPack, GenerationManifest, ObjectKind};
