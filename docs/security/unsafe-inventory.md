...
The current kernel contains exactly 206 project-authored Rust `unsafe` tokens,
all in the three audited modules of `crates/troe-machine`. The verification gate
