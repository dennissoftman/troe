...
PACKAGE_SCENARIOS = {
    ...
    "troe-fs-ramfs": {"boot", "filesystem", "quota-memory"},
    "troe-fmt-gpt": {"boot", "filesystem", "persistence"},
    ...
    "troe-fmt-bmnt": {"boot", "filesystem"},
    "troe-net": {"boot", "network"},
    "troe-fmt-prgn": {"boot", "persistence"},
    "troe-txslot": {"boot", "persistence", "fault-isolation"},
    "troe-platform": {"boot", "network", "framebuffer-keyboard"},
    "troe-shell": {"boot", "shell-terminal", "filesystem"},
    "troe-fs-statefs": {"boot", "filesystem", "persistence", "fault-isolation"},
    "troe-volume": {"boot", "filesystem", "persistence", "fault-isolation"},
    "troe-task": {"boot", "quota-memory", "fault-isolation"},
    "troe-terminal": {"boot", "shell-terminal", "framebuffer-keyboard"},
    "troe-namespace": {"boot", "filesystem", "quota-memory"},
...
PYTHON_IMPACTS = {
    ...
    "scripts/alpine_profile.py": ("test_alpine_profile.py",),
    ...
    "tools/mkcloud.py": ("test_cloud_artifacts.py", "test_setup_troe.py"),
    "tools/setup_troe.py": (
        "test_setup_troe.py",
        "test_cloud_hypervisor_profile.py",
    ),
    ...
    "tools/system_lifecycle.py": ("test_system_lifecycle.py",),
    "tools/troe_system.py": ("test_system_lifecycle.py",),
    "tools/cloud-environments.json": (
        "test_cloud_artifacts.py",
        "test_qemu_profile.py",
    ),
    "tools/cloud-hypervisor-profile.json": ("test_cloud_hypervisor_profile.py",),
    "tools/alpine-profile.json": ("test_alpine_profile.py",),
